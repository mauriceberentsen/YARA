...
Compatibility and benchmark jobs output structured evidence with environment, commit, artifact digests and results. Catalog promotion consumes reviewed evidence. Test logs alone are not durable catalog facts.
