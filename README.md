...
- a content-addressed `ContractTestResult` across read-only SSH preflight, isolated runtime smoke, bounded model inference, exact advertised-context boundary and serving-container policy testing;
