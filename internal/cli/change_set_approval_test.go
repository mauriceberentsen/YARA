...
func TestReceiptValidationIsValidationOnly(t *testing.T) {
	...
	receipt := resources.DeploymentReceipt{
		...
		Spec: resources.DeploymentReceiptSpec{
			...
			PlanID: testCLIDigest('a'), BundleID: testCLIDigest('b'), PreflightResultID: testCLIDigest('c'), ChangeSetID: testCLIDigest('d'), ApprovalID: testCLIDigest('e'), AuthorizationID: testCLIDigest('f'), ImportReceiptID: testCLIDigest('0'),
